...
const syncDocs = safeRequire('../modules/sync/sync.docs');
// ✅ Importación de la documentación del nuevo módulo
const rankHistoryDocs = safeRequire('../modules/rankHistory/rankHistory.docs');
...
const finalSpec = deepmerge.all([
  ...
  teamsDocs,
  syncDocs,
// ✅ Inclusión del nuevo módulo para su fusión
  rankHistoryDocs,
]);
